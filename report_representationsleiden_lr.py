...
alphas      = [0.0, 0.1, 1.0, 5.0, 10.0, 30.0]
# alphas      = [0.0,0.5]
# alphas     = [10.0]
# resolutions = [2.0]
resolutions = [2.0, 5.0, 7.0]
...
# Summarize results.
summarize_run(alphas, resolutions, meta_folder, meta_field, min_tiles, folds_pickle, h5_complete_path, ylim=[0,1.01])
